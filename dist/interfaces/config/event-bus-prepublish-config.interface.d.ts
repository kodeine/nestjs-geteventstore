...
export interface IEventBusPrepublishConfig<T extends IBaseEvent = IBaseEvent> {
    validate?: Type<IEventBusPrepublishValidateProvider<T>> | IEventBusPrepublishValidateProvider<T>;
    prepare?: Type<IEventBusPrepublishPrepareProvider<T>> | EventBusPrepublishPrepareCallbackType<T>;
}
